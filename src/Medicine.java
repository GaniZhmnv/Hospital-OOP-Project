public class Medicine {
    ...
    public void setMedicineId(int medicineId) {if (medicineId >= 100) {
        this.medicineId = medicineId;
    } else {
    ...
    public void setPrice(double price) {if (price > 0) {
        this.price = price;
    } else {
    ...
    public void applyDiscount(double percentage) {if (percentage > 0 && percentage <= 100) {
